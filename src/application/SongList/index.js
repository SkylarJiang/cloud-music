...
import { List, SongItem } from "./style";
import { getName } from '../../api/utils';
import { changePlayList, changeCurrentIndex, changeSequencePlayList } from '../../application/Player/store/actionCreator'
...
const SongsList = React.forwardRef ((props, refs)=> {
    ...
    return (
        <List ref={refs} showBackground={props.showBackground}>
